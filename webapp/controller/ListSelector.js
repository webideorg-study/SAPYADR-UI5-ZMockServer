sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("ZMockServer.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ac.TaskProcessing_Application.controller.ListSelector
			 */
			 ...
			 * @return {ac.TaskProcessing_Application.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
